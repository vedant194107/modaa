...
async function initCategoriesTable() {
  ...
  if (check.count === 0) {
    ...
    const defaults = [
      ...
      ["cat_footwear", "Footwear", "footwear", "Chunky combat boots, technical sneakers, and premium leather slides.", "https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"],
    ];
